...
-- 
\echo Insert a peach candle, given by 'Santa' thats value is 9 
\and has been previously regifted
-- 
...
VALUES
('vanilla candle', 'Mom', '25', FALSE),
('magic candle', 'Grandpa', '5', TRUE),
('teddy the bear', 'Girlfriend', '19', FALSE),
('magic cream', 'Amy', '10', TRUE),
('pearls', 'Santa', '1000', FALSE);
...
--
SELECT ROUND(AVG(price), 2) FROM gifts;
